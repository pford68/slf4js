...
function LoggingDecorator(logger, options) {
    options = options || {};
    // NOTE:  Mixing into baseLogger prevents implementations from having to implement all Logger methods.
    this.logger = _.extend({}, baseLogger, logger, options);
}
...
module.exports = function(config){
    logConfig = config;
    baseLogger = require("./loggers/ConsoleLogger")(logConfig);
    debugEnabled = true;
